...
This document describes data analysis of Agnese Mancini's data of green turtle capture recapture events of hawksbill turtles using the augmented method (Kery and Schaub). This version uses only those turtles with CCL information available. 
