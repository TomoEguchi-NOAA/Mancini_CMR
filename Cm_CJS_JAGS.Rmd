...
According to DIC, phi(.) p(t) is the best.  Let's take a look at the results.
...
```{r}
p.stats <- phidot.pt$jags.out$summary[grep("p[", 
                                           dimnames(phidot.pt$jags.out$summary)[[1]],
                                           fixed = TRUE),]
p.stats
```
...
```{r}
N.stats <- phidot.pt$jags.out$summary[grep("N[", 
                                           dimnames(phidot.pt$jags.out$summary)[[1]],
                                           fixed = TRUE),]
