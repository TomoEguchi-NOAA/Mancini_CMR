...
knitr::kable(data.frame(model = BKS.model.comp$Model,
...
Nhats_comparison(loc, N.Phi.p.hats.Mark.1, 
...
Look at the second best model with the Bayesian approach.

```{r}

N.Phi.p.hats.Jags <- stats.Bayesian_v5(rownames(BKS.model.comp)[2], 
