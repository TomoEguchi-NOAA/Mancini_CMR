...
All datasets, except PAO, passed test2.ct except PAO (Table \@ref(tab:table-test2ct)).
...
knitr::kable(BKS.model.comp %>% select(Model, DeltaAICc), 
             digits = 2,
...
```{r}
Cm.results$Phi.dot.p.t$results$real
