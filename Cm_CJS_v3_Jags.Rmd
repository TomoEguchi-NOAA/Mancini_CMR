...
for (k in 1:length(community.names)){
  ...
  if (!file.exists(paste0("RData/CJS_Cm_jags_", community.names[k], ".rds"))){
    ...
    if (p.recap[k] > 0.05){
      ...
      MCMC.params$model.file <- "models/Model_CJS_Phidot_pt.txt"
      ...
      saveRDS(out.list, 
              file = paste0("RData/CJS_Cm_jags_", community.names[k], ".rds"))
