...
In this version, I decided to use the best model from Mark analysis (CJS_Mark_community.Rmd) and use them in the Bayesian approach, rather than fitting all models and compare them. It is a bit lazy but I couldn't quite figure out LOOIC and Pareto k statistics using Bernoulli distribution... Also, this is a bit (lot) fastser. 
...
for (k in 1:length(community.names)){
  ...
  MCMC.params$model.file <- paste0("Model_CJS_", filter(models.MARK, 
