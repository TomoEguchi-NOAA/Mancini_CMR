---
title: "Capture recapture analyses of hawksbills at Cabo Pulmo for Agnese Mancini"
output: html_notebook
---

This document describes data analysis of Agnese Mancini's data of hawksbill turtle capture recapture events at Cabo Pulmo (CPU) using the augmented method (Kery and Schaub). Because many don't have 
...
dat.1 <- get.data.Ei("data/GTC_ICAPO_CPU.csv")
...
if (!file.exists(paste0("RData/CJS_pdot_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, file = paste0("RData/CJS_pdot_Ei_CPU_JAGS.rds"))
  
} else {
  out.list <- readRDS(file = "RData/CJS_pdot_Ei_CPU_JAGS.rds")
...
pt
```{r}
if (!file.exists(paste0("RData/CJS_pt_EI_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_pt_Ei_CPU_JAGS.rds"))
  
} else {
  out.list <- readRDS(file = "RData/CJS_pt_Ei_CPU_JAGS.rds")
}
...
if (!file.exists(paste0("RData/CJS_pTrapResponse_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_pTrapResponse_Ei_CPU_JAGS.rds"))
  
} else {
  out.list <- readRDS(file = "RData/CJS_pTrapresponse_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiTSM_pt_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiTSM_pt_Ei_CPU_JAGS.rds"))
} else {
  out.list <- readRDS(file = "RData/CJS_PhiTSM_pt_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiTSM_pTSM_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiTSM_pTSM_Ei_CPU_JAGS.rds"))
} else {
  out.list <- readRDS(file = "RData/CJS_PhiTSM_pTSM_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiTSM_pEff_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiTSM_pEff_Ei_CPU_JAGS.rds"))
} else {
  out.list <- readRDS(file = "RData/CJS_PhiTSM_pEff_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiMinCCL_pdot_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiMinCCL_pdot_Ei_CPU_JAGS.rds"))
  
} else {
  out.list <- readRDS(file = "RData/CJS_PhiMinCCL_pdot_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiCCL_pt_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list,
          file = paste0("RData/CJS_PhiCCL_pt_Ei_CPU_JAGS.rds"))
} else {
  out.list <- readRDS(file = "RData/CJS_PhiCCL_pt_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiAgeClass_pt_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiAgeClass_pt_Ei_CPU_JAGS.rds"))
} else {
  out.list <- readRDS(file = "RData/CJS_PhiAgeClass_pt_Ei_CPU_JAGS.rds")
...
if (!file.exists(paste0("RData/CJS_PhiAgeClass_TSM_pt_Ei_CPU_JAGS.rds"))){
  ...
  saveRDS(out.list,
          file = paste0("RData/CJS_PhiAgeClass_TSM_pt_Ei_CPU_JAGS.rds"))
} else {
  out.list <- readRDS(file = "RData/CJS_PhiAgeClass_TSM_pt_Ei_CPU_JAGS.rds")
...
phidot.pdot <- readRDS(file = "RData/CJS_pdot_Ei_CPU_JAGS.rds")
phidot.pt <- readRDS(file = "RData/CJS_pt_Ei_CPU_JAGS.rds")
phidot.pTrap <- readRDS(file = "RData/CJS_pTrapresponse_Ei_CPU_JAGS.rds")
phiTSM.pt <- readRDS(file = "RData/CJS_PhiTSM_pt_Ei_CPU_JAGS.rds")
#phiTSM.pEff <- readRDS(file = "RData/CJS_PhiTSM_pTSM_Ei_CPU_JAGS.rds")
phiTSM.pTSM <- readRDS(file = "RData/CJS_PhiTSM_pTSM_Ei_CPU_JAGS.rds")
#phiMinCCL.pdot <- readRDS(file =  "RData/CJS_PhiMinCCL_pdot_Ei_CPU_JAGS.rds")
phiAgeClass.pt <- readRDS(file =  "RData/CJS_PhiAgeClass_pt_Ei_CPU_JAGS.rds")
phiAgeClass.TSM.pt <- readRDS(file =  "RData/CJS_PhiAgeClass_TSM_pt_Ei_CPU_JAGS.rds")

phiCCL.pt <- readRDS(file = "RData/CJS_PhiCCL_pt_Ei_CPU_JAGS.rds")
```
...
According to DIC, phi(TSM) p(t) is the best, although phi(AgeClass, TSM) p(t), phi(.) p(.), phi(AgeClass) p(t) are deltaDIC < 3. Let's take a look at the results from the first model.

```{r}
phiTSM.pt$jags.out$summary %>% as.data.frame() %>% rownames_to_column(var = "Parameter") %>%
  select(Parameter, mean, sd, "2.5%", "50%", "97.5%", Rhat) -> phiTSM.pt.df

#phiCCL.pt.df
p.stats <- phiTSM.pt.df[grep("p[",
                             phiTSM.pt.df$Parameter,
                             fixed = TRUE),]
p.stats %>% select(-Rhat)
```
...
Survival rate
There are two survival rates; one for the first capture and the other is for the rest (gamma[1] and gamma[2]). 
```{r}
phiTSM.pt.df %>% filter(Parameter == "gamma[1]" | Parameter == "gamma[2]")
```


```{r}
mcmc_dens(phiTSM.pt$jags.out$samples, pars = c("gamma[1]", "gamma[2]"))
...
```{r}
N.stats.df <- phiTSM.pt.df[grep("N[", 
                             phiTSM.pt.df$Parameter,
                             fixed = TRUE),]
...
ggsave(filename = "figures/CPU_Nhats.png",
