...
if (!file.exists(paste0("RData/CJS_pdot_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, file = paste0("RData/CJS_pdot_CCL_Ei_IES_JAGS.rds"))
...
pt
```{r}
if (!file.exists(paste0("RData/CJS_pt_CCL_EI_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_pt_CCL_Ei_IES_JAGS.rds"))
...
if (!file.exists(paste0("RData/CJS_pTrapResponse_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_pTrapResponse_CCL_Ei_IES_JAGS.rds"))
...
if (!file.exists(paste0("RData/CJS_PhiTSM_pt_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiTSM_pt_CCL_Ei_IES_JAGS.rds"))
}
```
...
if (!file.exists(paste0("RData/CJS_PhiTSM_pTSM_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiTSM_pTSM_CCL_Ei_IES_JAGS.rds"))
}
```
...
if (!file.exists(paste0("RData/CJS_PhiTSM_pEff_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiTSM_pEff_CCL_Ei_IES_JAGS.rds"))
}
```
...
if (!file.exists(paste0("RData/CJS_PhiMinCCL_pdot_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiMinCCL_pdot_CCL_Ei_IES_JAGS.rds"))
...
if (!file.exists(paste0("RData/CJS_PhiCCL_pt_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list,
          file = paste0("RData/CJS_PhiCCL_pt_CCL_Ei_IES_JAGS.rds"))
}
...
if (!file.exists(paste0("RData/CJS_PhiAgeClass_pt_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list, 
          file = paste0("RData/CJS_PhiAgeClass_pt_CCL_Ei_IES_JAGS.rds"))
}
...
if (!file.exists(paste0("RData/CJS_PhiAgeClass_TSM_pt_CCL_Ei_IES_JAGS.rds"))){
  ...
  saveRDS(out.list,
          file = paste0("RData/CJS_PhiAgeClass_TSM_pt_CCL_Ei_IES_JAGS.rds"))
}
```
Look at the results and compare which model may be better:

```{r}
phidot.pdot <- readRDS(file = "RData/CJS_pdot_CCL_Ei_IES_JAGS.rds")
phidot.pt <- readRDS(file = "RData/CJS_pt_CCL_Ei_IES_JAGS.rds")
phidot.pTrap <- readRDS(file = "RData/CJS_pTrapresponse_CCL_Ei_IES_JAGS.rds")
phiTSM.pt <- readRDS(file = "RData/CJS_PhiTSM_pt_CCL_Ei_IES_JAGS.rds")
phiTSM.pEff <- readRDS(file = "RData/CJS_PhiTSM_pEff_CCL_Ei_IES_JAGS.rds")
phiTSM.pTSM <- readRDS(file = "RData/CJS_PhiTSM_pTSM_CCL_Ei_IES_JAGS.rds")
phiMinCCL.pdot <- readRDS(file = "RData/CJS_PhiMinCCL_pdot_CCL_Ei_IES_JAGS.rds")
#phiCCL.pt <- readRDS(file = "RData/CJS_PhiCCL_pt_CCL_Cm_JAGS.rds")
phiAgeClass.pt <- readRDS(file = "RData/CJS_PhiAgeClass_pt_CCL_Ei_IES_JAGS.rds")
phiAgeClass.TSM.pt <- readRDS(file = "RData/CJS_PhiAgeClass_TSM_pt_CCL_Ei_IES_JAGS.rds")
...
According to DIC, phi(dot) p(t) is the best, although phi(ageclass) p(t) is a very close second.  Let's take a look at the results from the both models.
